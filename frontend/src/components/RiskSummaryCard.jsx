...
const RiskSummaryCard = ({ analysis }) => {
  ...
  let riskColor = '#10B981'; // Green (Safe/Low)
  if (riskScore > 5 && riskScore <= 10) riskColor = '#F59E0B'; // Orange (Medium)
  else if (riskScore > 10 && riskScore <= 15) riskColor = '#EF4444'; // Red (High)
  else if (riskScore > 15) riskColor = '#991B1B'; // Dark Red (Critical)
    ...
    <div className="risk-summary-card-refactored fade-in">
      ...
      <div className="conic-gauge" style={gaugeStyle}>
        <div className="gauge-inner-circle">
          <span className="gauge-score-text" style={{ color: riskColor }}>
